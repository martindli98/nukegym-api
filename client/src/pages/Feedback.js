  ...
  return (
    ...
    >           
            <div className="max-w-lg w-full text-center p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="mb-6">¿Tenés una queja o sugerencia? ¡Nos encantaría saber tu opinión! 💡</p>

                {submitted && <p className="text-green-600 font-bold mb-4">¡Gracias por tu comentario!</p>}
