    ...
    <nav className="navbar">
      <div className="navbar-logo">
        <img 
            ...
            />
        <span style={{ color: "#F97709" }}>NUKE</span><span style={{ color: "#691C84" }}>GYM</span>
      </div>
      <ul className="navbar-links">
        ...
        <li>
          <Link to="/jobs" className={location.pathname === '/jobs' ? 'active' : ''}>Membresia</Link>
        </li>
        ...
        {userData ? (
          ...
          <>
            ...
            <li>
              <Link to="/signup" className={location.pathname === '/signup' ? 'active' : ''}>Registrarse</Link>
            </li>
          </>
        )}
      </ul>
